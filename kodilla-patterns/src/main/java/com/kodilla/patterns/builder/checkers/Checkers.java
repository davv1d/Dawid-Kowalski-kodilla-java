...
public class Checkers {
    ...
    public static class CheckersBuild {
        private Board board = new Board();
        private String playerOne = "";
        private String playerTwo = "";

        public CheckersBuild PlayerOne(String playerOne) {
            this.playerOne = playerOne;
            return this;
        }

        public CheckersBuild PlayerTwo(String playerTwo) {
            this.playerTwo = playerTwo;
            return this;
        }

        public CheckersBuild Figure(String figureType, String figureColor, int x, int y) {
