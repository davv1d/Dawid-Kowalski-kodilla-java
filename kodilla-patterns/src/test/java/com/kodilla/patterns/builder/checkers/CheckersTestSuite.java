...
public class CheckersTestSuite {
    @Test
    public void testCheckersBuild() {
        //Given
        Checkers checkers = new Checkers.CheckersBuild()
                .PlayerOne("John")
                .PlayerTwo("Theresa")
        ...
        Figure figureTree = checkers.getBoard().getFigure(0,2);
        ...
        Assert.assertEquals(Queen.class, figureTree.getClass());
